#!/usr/bin/env bash
# 将 ssm-social-demo 打成 war 并部署到本路径 tools 下的 Tomcat。
# 用法：在 java-35-weeks/ 下执行 ./deploy/deploy-ssm-social-demo.sh；或在 Git 仓库根执行 ./java-35-weeks/deploy/deploy-ssm-social-demo.sh
